...
final class OAuth2Events
{
     ...
     */
    public const USER_RESOLVE = 'ezpizee.oauth2.user_resolve';
     ...
     */
    public const SCOPE_RESOLVE = 'ezpizee.oauth2.scope_resolve';
     ...
     */
    public const AUTHORIZATION_REQUEST_RESOLVE = 'ezpizee.oauth2.authorization_request_resolve';
}
